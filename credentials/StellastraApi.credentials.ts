...
export class StellastraApi implements ICredentialType {
	name = 'N8nDevStellastraApi';

	displayName = 'stellastra API';

	icon: Icon = { light: 'file:../nodes/Stellastra/stellastra.svg', dark: 'file:../nodes/Stellastra/stellastra.dark.svg' };
	...
	properties: INodeProperties[] = [
		{
			...
			name: 'url',
			type: 'string',
			default: 'https://stellastra.com/api/',
			required: true,
			placeholder: 'https://stellastra.com/api/',
			description: 'The base URL of your stellastra API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
